...
public class ViewNationalite {
    ...
    public ViewNationalite(ViewHandler vhNationalite, Group root) {
        this.root = root;
        ...
        titreFilm = iniTitre("Nationalité",150, 200);
    ...
    public void setEvents(ControllerNationalite cm) {
        btnEnvoyer.setOnMouseClicked(cm);
        btnBackMainP.setOnMouseClicked(cm);
    }

    //setter
    public void setEventsBack(ControllerNationalite cm) { btnBackMainP.setOnMouseClicked(cm); }
